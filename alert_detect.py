        ...
        for x in colors:
            ...
            if ((x[0][0] == 223 and x[0][1] == 239 and x[0][2] == 140) or (
               ...
               # frameoriginalextract.show()
                ...
                # mail.login('swatikasar17@gmail.com','9922045432')
                ...
                account_sid = 'AC3dc235d488cee7084ab19400cd91ff3c'
                auth_token = 'f6774a142bf15116ec2603f4b56510bb'
